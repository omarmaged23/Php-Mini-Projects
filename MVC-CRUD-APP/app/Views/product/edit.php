    ...
    <div class="col-8 mx-auto">
      ...
      <form class="p-5 border mb-5" method="POST" action="<?php url('product/update/' . $row['id']); ?>">
        <div class="form-group">
          ...
          <input type="text" required name="name" class="form-control" id="name" value="<?php echo $row['name']; ?>">
        </div>
        <div class="form-group">
          <label for="price">Price</label>
          <input type="text" required class="form-control" name="price" id="price" value="<?php echo $row['price']; ?>">
        </div>
